const apiBase = "http://localhost:1111/api/cars"
        ...
        .then(cars => {
            ...
            cars.forEach(car => {
              ...
              <tr class="text-center">
                ...
                <td class="border p-2">
                  <button onclick="openEditModal(${car.id}, '${car.make}', '${car.model}', '${car.licensePlateNumber}', ${car.year}, '${car.color}', '${car.bodyType}', '${car.engineType}', '${car.transmission}')" class="bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600">Edit</button>
...
function saveCar(e) {
    ...
    const licensePlateNumber = document.getElementById("carLicensePlateNumber").value
